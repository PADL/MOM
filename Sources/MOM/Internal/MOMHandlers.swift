...
enum MOMHandlers {
  typealias Builtin = @Sendable (
    _ controller: MOMController,
    _ peer: MOMPeerContext,
    _ event: MOMEvent,
    _ params: inout [MOMParameter]
  ) -> MOMStatus
  ...
  private static func int(_ p: MOMParameter?) -> Int32? {
    if case let .int(v) = p { return v }
    return nil
  }

  private static func string(_ p: MOMParameter?) -> String? {
    if case let .string(v) = p { return v }
    return nil
  }
  ...
  private static func aliveRequest(
    _ c: MOMController,
    _ peer: MOMPeerContext,
    _ event: MOMEvent,
    _ p: inout [MOMParameter]
  ) -> MOMStatus {
    .success
  }

  /// HostGetRequest — `<version=2>` → `[<version>, 1, systemTypeAndVersion, serialNumber]`
  private static func getHardwareConfig(
    _ c: MOMController,
    _ peer: MOMPeerContext,
    _ event: MOMEvent,
    _ p: inout [MOMParameter]
  ...
  private static func getSoftwareVersion(
    _ c: MOMController,
    _ peer: MOMPeerContext,
    _ event: MOMEvent,
    _ p: inout [MOMParameter]
  ...
  private static func getAliveTime(
    _ c: MOMController,
    _ peer: MOMPeerContext,
    _ event: MOMEvent,
    _ p: inout [MOMParameter]
  ...
  private static func setAliveTime(
    _ c: MOMController,
    _ peer: MOMPeerContext,
    _ event: MOMEvent,
    _ p: inout [MOMParameter]
  ...
  private static func setDeviceID(
    _ c: MOMController,
    _ peer: MOMPeerContext,
    _ event: MOMEvent,
    _ p: inout [MOMParameter]
  ...
  private static func getIPAddress(
    _ c: MOMController,
    _ peer: MOMPeerContext,
    _ event: MOMEvent,
    _ p: inout [MOMParameter]
  ...
  private static func setIPAddress(
    _ c: MOMController,
    _ peer: MOMPeerContext,
    _ event: MOMEvent,
    _ p: inout [MOMParameter]
  ...
  private static func getKeyMode(
    _ c: MOMController,
    _ peer: MOMPeerContext,
    _ event: MOMEvent,
    _ p: inout [MOMParameter]
  ...
  private static func setKeyMode(
    _ c: MOMController,
    _ peer: MOMPeerContext,
    _ event: MOMEvent,
    _ p: inout [MOMParameter]
