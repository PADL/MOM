...
internal enum MOMMessage {
  ...
  enum DecodeOutcome: Equatable {
    case ok(event: MOMEvent, params: [MOMParam])
  ...
  static func tagByte(for type: MOMEvent) -> UInt8 {
    switch type {
    case .typeHostGetRequest:      return 0x3F  // ?
    case .typeHostSetRequest:      return 0x26  // &
    case .typeHostNotification:    return 0x25  // %
    case .typeDeviceReply:         return 0x3A  // :
    case .typeDeviceNotification:  return 0x21  // !
    default:                       return 0
    }
  }
  ...
  static func eventType(for tag: UInt8) -> MOMEvent? {
    switch tag {
    case 0x3F: return .typeHostGetRequest
    case 0x26: return .typeHostSetRequest
    case 0x25: return .typeHostNotification
    case 0x3A: return .typeDeviceReply
    case 0x21: return .typeDeviceNotification
    default:   return nil
    }
  }
  ...
  /// no wire name.
  static func encode(_ event: MOMEvent, params: [MOMParam]) -> Data? {
    let type = event.type
    precondition(type == .typeDeviceReply || type == .typeDeviceNotification,
  ...
  static func decode(_ data: Data) -> DecodeOutcome {
    ...
    let tagByte = UInt8(tagScalar.value & 0xFF)
    guard let type = eventType(for: tagByte) else { return .invalid }
