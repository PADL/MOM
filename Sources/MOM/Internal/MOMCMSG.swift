...
internal enum MOMCmsg {
  ...
  static var cmsgHeaderSize: Int { align(MemoryLayout<cmsghdr>.size) }

  static func space(_ payload: Int) -> Int { align(MemoryLayout<cmsghdr>.size) + align(payload) }
  static func length(_ payload: Int) -> Int { align(MemoryLayout<cmsghdr>.size) + payload }
  ...
  @discardableResult
  static func writePktInfo(_ pktInfo: in_pktinfo,
                           into control: UnsafeMutableRawBufferPointer) -> Int {
