...
public struct MOMEvent: RawRepresentable, Hashable, Sendable {
  ...
  public static let typeHostGetRequest = MOMEvent(rawValue: 0x0100_0000)
  public static let typeHostSetRequest = MOMEvent(rawValue: 0x0200_0000)
  public static let typeHostNotification = MOMEvent(rawValue: 0x0400_0000)
  public static let typeHostAny = MOMEvent(rawValue: 0x0F00_0000)

  public static let typeDeviceReply = MOMEvent(rawValue: 0x1000_0000)
  public static let typeDeviceNotification = MOMEvent(rawValue: 0x2000_0000)
  public static let typeDeviceAny = MOMEvent(rawValue: 0xF000_0000)

  public static let typeMask = MOMEvent(rawValue: 0xFF00_0000)
  ...
  public var type: MOMEvent {
    MOMEvent(rawValue: rawValue & Self.typeMask.rawValue)
  }

  public var event: MOMEvent {
    MOMEvent(rawValue: rawValue & Self.eventMask.rawValue)
  }
  ...
  public var isHostNotification: Bool {
    type == .typeHostNotification
  }

  public var isDeviceReply: Bool {
    type == .typeDeviceReply
  }

  public var isDeviceNotification: Bool {
    type == .typeDeviceNotification
  }
}
